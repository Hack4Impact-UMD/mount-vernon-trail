...
export const METRICS_CONFIG: MetricCategoryConfig[] = [
    {
        id: "drainage",
        label: "Drainage",
    ...
    },
    {
        ...
        fields: [
            { id: "lengthEdged", label: "Length of trail edged (approx.)", unit: "ft" },
        ],
    },
    {
        id: "trash",
...
export const TOTAL_METRIC_FIELDS = METRICS_CONFIG.reduce(
